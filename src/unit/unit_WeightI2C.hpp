...
public:
    ...
    inline float weight() const
    {
        ...
        float w = oldest().weight();
        return _gap_negative ? -w : w;
    }
    /*!
    ...
    */
    ...
    /*!
      ...
      @warning During periodic detection runs, an error is returned
      @warning When GAP is negative, the string contains a sign-inverted value.
      The string is generated by the firmware and cannot be corrected on the library side.
     */
...
protected:
    ...
    config_t _cfg{};
    bool _gap_negative{};  //!< True if GAP value is negative (load cell polarity)
};
